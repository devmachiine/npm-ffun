...
Dependencies often entail breaking changes. Often, especially for small pieces of code, developers prefer to copy or re-invent the wheel to avoid the [dependency problem](https://www.youtube.com/watch?v=oyLBGkS5ICk) all togehter.
